...
# #*/
#
# data "aws_iam_policy_document" "aws-elb-policy-document" {
#  statement {
#    effect = "Allow"
#
#    principals {
...
#   role       = aws_iam_role.aws-elb-role.name
...
# # }
#
# resource "aws_eks_pod_identity_association" "aws-elb-pod-identity" {
#  cluster_name    = aws_eks_cluster.dev-eks.name
#  namespace       = "kube-system"
#  service_account = "aws-load-balancer-controller"
#  role_arn        = aws_iam_role.aws-elb-role.arn
# }
#
# resource "helm_release" "aws-elb" {
#
#  depends_on = [aws_eks_pod_identity_association.aws-elb-pod-identity,null_resource.get-config]
#
